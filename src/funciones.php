...
function editarCliente($CliNombre, $CliApellido, $CliIdentificacion, $CliTelefono, $CliCorreo, $idEmpleado){
    $sentencia = "UPDATE clientes SET CliNombre=?, CliApellido=?, CliIdentificacion=?, CliTelefono=?, CliCorreo=?, idEmpleado=? WHERE id = ?";
    $parametros = [$CliNombre, $CliApellido, $CliIdentificacion, $CliTelefono, $CliCorreo, $idEmpleado];
    return editar($sentencia, $parametros);
}
...
function registrarCliente($CliNombre, $CliApellido, $CliIdentificacion, $CliTelefono, $CliCorreo, $idEmpleado){
    $sentencia = "INSERT INTO clientes (CliNombre, CliApellido, CliIdentificacion, CliTelefono, CliCorreo, idEmpleado) VALUES (?,?,?)";
    $parametros = [$CliNombre, $CliApellido, $CliIdentificacion, $CliTelefono, $CliCorreo, $idEmpleado];
